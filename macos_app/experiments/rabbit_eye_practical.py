...
class SplashFrame(tk.Frame):
    def __init__(self, parent, app):
        ...
        # ---------- Neutral CAL emblem ----------
        c.create_oval(302, 30, 398, 126, fill=C["bg2"], outline=C["gold"], width=3)
        c.create_text(350, 69, text="CAL", font=("Segoe UI", 22, "bold"), fill=C["gold"])
        c.create_text(350, 92, text="PHARMACOLOGY", font=("Segoe UI", 7, "bold"), fill=C["text2"])
        ...
        c.create_text(
            680, 470,
            text="Professor of Pharmacology",
            anchor="e",
            font=("Segoe UI", 10),
            fill=C["text3"]
        )
        ...
        c.create_text(
            680, 488,
            text="with assistance from generative AI tools  •  MAMC, New Delhi",
            anchor="e",
            font=("Segoe UI", 8),
            fill=C["text3"]
        )
...
class SetupFrame(tk.Frame):
    def __init__(self, parent, app):
        ...
        tk.Label(self, text="EXPERIMENT SETUP", font=("Segoe UI", 18, "bold"),
        ...
        tk.Label(self, text="Select drug and choose which eye receives it. "
                 ...
                 font=("Segoe UI", 11), bg=C["bg"], fg=C["text2"]).pack(pady=(0, 20))
        ...
        tk.Button(self, text="💉  Administer Drug & Begin Experiment",
                  font=("Segoe UI", 14, "bold"), bg=C["gold"], fg=C["bg3"],
                  activebackground="#c49000", relief="flat", padx=30, pady=12,
                  cursor="hand2", command=self._go
                   ).pack(pady=25)
        tk.Label(self, text="MAMC, New Delhi", font=("Segoe UI", 8),
                 bg=C["bg"], fg=C["text3"]).place(relx=1.0, rely=1.0,
                                                    x=-10, y=-8, anchor="se")
...
class ExperimentFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(top, text="Rabbit Eye Experiment", font=("Segoe UI", 13, "bold"),
                 bg=C["bg2"], fg=C["gold"]).pack(side="left", padx=(10, 0))
        tk.Label(top, text=f"  •  Drug: {self.drug_name}",
                 font=("Segoe UI", 11), bg=C["bg2"], fg=C["text2"]).pack(side="left")
        tk.Button(top, text="↻ New Experiment", font=("Segoe UI", 10),
                  bg=C["bg"], fg=C["text2"], relief="flat", cursor="hand2",
                   command=self.app.show_setup).pack(side="right", padx=10, pady=8)
        tk.Label(top, text="MAMC, New Delhi", font=("Segoe UI", 8),
                 bg=C["bg2"], fg=C["text3"]).pack(side="right", padx=(6, 2))
        ...
        # Comparison
        tk.Label(rpanel, text="COMPARISON", font=("Segoe UI", 10, "bold"),
        ...
        for col, (h, clr) in enumerate([("Parameter", C["text2"]),
                                         ...
                                         ("Saline", C["green"])]):
            tk.Label(cf, text=h, font=("Segoe UI", 9, "bold"),
        ...
        for r, (param, dv, sv) in enumerate(rows, 1):
            tk.Label(cf, text=param, font=("Segoe UI", 9), bg=C["bg"],
            ...
            tk.Label(cf, text=dv.upper(), font=("Segoe UI", 9, "bold"),
                     bg=C["bg"], fg=dc).grid(row=r, column=1, padx=4, pady=2)
            tk.Label(cf, text=sv.upper(), font=("Segoe UI", 9, "bold"),
...
class RabbitEyeApp:
    def __init__(self, root, image_dir=None):
        self.root = root
        self.root.title("Rabbit Eye Experiment — Virtual Pharmacology Laboratory")
        ...
        try:
            ...
            try:
                ...
                set_window_size(self.root, 1280, 780, 900, 620)
